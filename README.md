...
- **HTTP latency percentile analysis (p50/p90/p95/p99), TTFB breakdown, tail ratio diagnostics**
- **Web attack-surface findings with Nginx/Apache/IIS remediation steps**
