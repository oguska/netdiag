...
if($ExportHtmlPath){
    ...
    $applicationMetricKeys = @(
        'JMeter_Threads','JMeter_Total_Requests','JMeter_Throughput_RPS','JMeter_Avg_Latency','JMeter_p90_Latency','JMeter_p95_Latency','JMeter_Error_Rate',
        'Ext_JMeter_File','Ext_JMeter_p95',
        'SSL_Subject','SSL_Issuer','SSL_Days_Left','HTTP_Code','HTTP_Total_Time',
        'HTTPS_Certificate_Status','HTTPS_Certificate_NotBefore','HTTPS_Certificate_NotAfter',
    ...
    $rowsApplication = New-Object Text.StringBuilder
    foreach ($x in $ReportData.GetEnumerator()) {
        ...
        if ($systemMetricKeys -contains $x.Key) {
            ...
            [void]$rowsApplication.Append($itemHtml)
        } else {
